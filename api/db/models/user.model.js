...
// this toJSON method is intented to override the default toJSON method as I don't want the password and the session to be public
...
UserSchema.pre('save', function(next) {
    let user = this;
    let costFactor = 10; // how long will it take to hash the password
...
let saveSessionToDatabase = (user, refreshToken) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        // push this object to the sessions array.
